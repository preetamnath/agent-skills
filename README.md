...
- **[opencode/plugins/](opencode/plugins/)** — Reusable OpenCode 2 plugins: provider-native lifecycle-event bridges and a tool-shell environment fix.
...
- **[map-design-language](skills/map-design-language/)** — Research an established UI and write or refresh a lean `meta/DESIGN.md` of grounded visual rules, toolkits, patterns, content guidance, source ownership, and maintenance triggers.
...
- **[Codex global storage cleanup](guides/codex-global-storage-cleanup.md)** — Remove inactive Codex releases, compact diagnostic logs, and disable memories and analytics without deleting transcripts.
