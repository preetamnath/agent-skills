...
Ask questions until you could confidently hand this off to be built. Use `AskUserQuestion` for any question with distinct choices — include your recommendation and why. Use plain text only for genuinely open-ended questions.
...
- **Always use `AskUserQuestion` for questions with distinct choices.** This is not optional. If you can enumerate the options, use the tool — include your recommendation and why. Plain text is only for genuinely open-ended questions with no enumerable answers.
