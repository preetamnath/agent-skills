...
- When I ask to commit, run `scripts/validate-skills.sh` and commit only if it passes.
- After a commit that adds or changes a skill/agent/command, offer to install the changed ones:
