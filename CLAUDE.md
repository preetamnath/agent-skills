...
- **Shared schemas** — `references/`. Canonical versions of schemas used across multiple skills. When updating a schema, edit here first, then propagate to each skill's appendix (search for `<!-- source: references/{filename} -->` comments).
