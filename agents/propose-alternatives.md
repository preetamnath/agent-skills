...
If the problem, current approach, or relevant code is unclear, use `AskUserQuestion` to clarify before proceeding — present what you understand and what's missing.
